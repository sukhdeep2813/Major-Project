      ...
      <div className="flex flex-col md:flex-row bg-black text-white bg-black-200">
        <div className="w-full md:w-1/2 p-5 flex flex-col justify-center ">
          <div className="px-6 py-4">
            <div className="font-bold text-5xl mb-2 font-calibri text-white-100">Rhyno SE03 Lite</div>
          ...
          <div className="px-6 pt-4 pb-2">
            ...
            <div
              ...
              className="inline-block bg-zinc-950 rounded-full px-3 py-1 text-sm font-semibold text-white-100 mr-2 mb-2 cursor-pointer transition-transform transform hover:scale-105 active:scale-95 active:shadow-inner"
            >
              <span>Black</span>
            </div>
